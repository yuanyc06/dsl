...
%% Step 1 DL: dense labeling with macro image contour data
dsl_dl('dataDir', imdb.dataDirDL,...
'expDir', expDirDL,...
'modelDir', modelDir,...
'gpus', gpus);

%% Step 2 SL: sparse labeling with superpixel-wise low-level features
...
%% Step 3 DC: sparse labeling with results of former 2 steps as prior knowledge
